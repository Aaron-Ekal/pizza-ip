...
createPizzaItem = () => {
  ...
  let orderText = document.createTextNode(
    newPizza.crustName + " " + newPizza.toppingsType + " " + newPizza.sizeName
  );
...
deliver = () => {
  address = prompt(
    "Which address do we deliver to? Please note we have a delivery fee of Ksh 150 within environs"
  );
...
pickUp = () => {
  alert(
    "Thank you! Your order will be ready in 45 mins. See you at Marsabit Plaza, Ground Floor. Please prepare a total of Ksh " +
      totalcost +
      " with you"
  );
};
